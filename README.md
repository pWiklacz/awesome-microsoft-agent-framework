...
- [Introducing Agent and Workflow Channels](https://devblogs.microsoft.com/agent-framework/introducing-agent-and-workflow-channels/) - Introducing Python hosting channel packages for exposing agents and workflows through OpenAI Responses, Telegram, A2A, and MCP interfaces.
...
- [Microsoft Agent Framework Playbook](https://valentina-alto.github.io/microsoft-agent-framework-playbook-fleets-generated/) - Chapter-based learning path covering MAF concepts from agent fundamentals to workflows, orchestration, streaming, middleware, and DevUI.
